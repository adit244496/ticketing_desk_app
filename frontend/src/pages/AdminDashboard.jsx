...
const AdminDashboard = ({ user, setUser }) => {
    ...
    const defaultRule = { department: '', issue_type: '', outlet: '', base_priority: 3, assigned_solver: '', deadline_hours: 24 };
                                ...
                                <form onSubmit={handleUpdateRule}>
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                                        <div>
                                            ...
                                            <select className="form-control" required value={editRule.department} onChange={e => setEditRule({ ...editRule, department: e.target.value })} style={{ fontSize: '10px', padding: '8px' }}>
                                                <option value="" disabled>Select Department</option>
                                                {departmentsList.map(d => <option key={d.department_name} value={d.department_name}>{d.department_name}</option>)}
                                            </select>
                                        </div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" className="form-control" required value={editRule.deadline_hours || 24} onChange={e => setEditRule({ ...editRule, deadline_hours: parseInt(e.target.value) })} style={{ fontSize: '10px', padding: '8px' }} />
                                        </div>
                                    </div>
